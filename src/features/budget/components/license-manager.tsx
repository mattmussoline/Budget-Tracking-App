...
export function LicenseManager({
  ...
  return (
    <SoftSurface className="overflow-hidden bg-gray-900">
      <div className="flex items-center gap-4 bg-gray-900 p-6 text-white md:p-8">
        ...
        <div>
          ...
          <p className="text-sm font-medium text-gray-300">Adjust titles, providers, payment amounts, cadence, or added month.</p>
        </div>
      </div>
        ...
        {licenses.length === 0 ? (
          ...
          licenses.map((license, index) => {
            ...
            <div key={license.id} className="overflow-hidden rounded-lg bg-white">
              <div className={`flex flex-col gap-2 border-l-8 p-4 sm:flex-row sm:items-center sm:justify-between ${index % 2 === 0 ? "bg-white" : "bg-blue-50"}`} style={{ borderLeftColor: providerColor.hex }}>
                <div>
