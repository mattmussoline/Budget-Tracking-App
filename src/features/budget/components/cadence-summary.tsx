  ...
  return (
    <SoftSurface className="p-6 md:p-8">
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
        {items.map((item) => (
          <div key={item.label} className="flex items-center gap-4 rounded-2xl p-4 soft-inset">
            <div className="grid h-11 w-11 shrink-0 place-items-center rounded-xl soft-raised-sm">
