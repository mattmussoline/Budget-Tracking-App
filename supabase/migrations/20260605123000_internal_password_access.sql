alter table if exists public.fiscal_year_members
drop constraint if exists fiscal_year_members_user_id_fkey;

alter table if exists public.fiscal_years
drop constraint if exists fiscal_years_owner_id_fkey;
